---
title: "Traitement d'images biomédicales et partage de flux de travail reproductibles"
...
format: 
  ...
  revealjs:
    footer: "Partage d'images et flux de travail reproductibles - Équipe de curation des données du DFDR"
...
::: {style="text-align: center;font-size: 60%"}
![](images/Microscope.jpeg){fig-alt="Une illustration humoristique sur le thème de la science, combinant du texte et un dessin de microscope. Sur le côté gauche, un texte en gras noir indique 'BRO, DO YOU EVEN SCOPE?' avec une illustration d’un microscope optique en dessous. Sur le côté droit, sur un fond bleu clair, le texte met en avant l'importance de la formation en microscopie : 'Un microscope est aussi bon que la personne qui l’utilise. La qualité des expériences peut être améliorée grâce à la formation.' Les mots 'microscope' et 'qualité des expériences' sont mis en évidence en bleu. L’image souligne avec humour l’importance d’une bonne formation pour obtenir des résultats de recherche de haute qualité en microscopie."fig-align="center"width="100%"}
:::
...
## Format de fichier de nouvelle génération OME-Zarr{.center}
...
- Traitez les ensembles de données [OME-Zarr](https://link.springer.com/article/10.1007/s00418-023-02209-1) en Python en utilisant [cet outil](https://github.com/Euro-BioImaging/ome_zarr_pyramid).
:::
::::
:::::
...
:::: {#second-column}
::: {style="text-align: left;font-size: 80%"}
[REMBI](https://www.nature.com/articles/s41592-021-01166-8) donne des directives sur les métadonnées pour répondre aux besoins des diverses communautés de l'imagerie biomédicale. 
...
## Services d'ontologie basés sur le Web {.center}
...
:::: {#second-column}
::: {style="text-align: center;font-size: 80%"}
![[Biportal](https://bioportal.bioontology.org/)](images/Bioportal.png){fig-alt="Capture d'écran de Bioportal. Il s'agit d'un référentiel complet d'ontologies biomédicales. L'interface fournit une barre de recherche permettant de trouver des termes d'ontologie biomédicale, avec des options de recherche avancée. Elle affiche également des graphiques représentant les visites et les statistiques clés du site." fig-align="center" width="100%"}
:::
::::
:::::
...
::: {style="text-align: left;font-size: 80%"}
Pour choisir la modalité de stockage, pensez qu'en tant que chercheurs, nous ne voulons pas simplement stocker l'ensemble de données quelque part, nous voulons le rendre [accessible et utilisable]{style="color:green ; "}. 
:::
...
::: {style="text-align: left;font-size: 70%"}
Ces instances sont installées dans un espace dédié du réseau (infrastructure centrale) pour un stockage et un partage à long terme.
:::
...
:::: {style="text-align: left;font-size: 60%"}
::: callout-tip
"Nous déconseillons fortement aux auteurs d'indiquer que les images « sont disponibles sur demande », car cette pratique s'est avérée inefficace."([Schmied et al. 2023](https://www.nature.com/articles/s41592-023-01987-9))
:::
::::
...
### Reproductible
::: {style="text-align: center;font-size: 60%"}
![De https://med.stanford.edu/](images/Replication.jpg){fig-alt="Illustration d'un chercheur en blouse blanche peignant sur une toile, qui contient une image de lui-même peignant sur une toile dans une boucle récursive infinie. L'arrière-plan est rouge, créant un contraste saisissant. L'œuvre symbolise la réplication scientifique, les processus auto-référentiels et la nature itérative de la recherche."fig-align="center"width="100%"}
:::
::::
:::::

## L'analyse d'images du point de vue de la GDR {.center}
...
## BioImage comme ressource pour les flux d'analyse d'images{.center}
...
## Les données doivent être partagées {.center}
...
:::: {style="text-align: left;font-size: 80%"}
Le dépôt d'un ensemble de données dans un référentiel [n'est [PAS SEULEMENT]{style="color:red ;"} un exercice visant à répondre aux exigences des organismes de financement et des journaux scientifiques. C'est une [responsabilité éthique et professionnelle]{style="color:green ;"} des chercheurs de garantir la reproductibilité de la recherche, ainsi que l'accès et la réutilisation des données de recherche.
::::
...
- Des chercheurs qui [s'engagent à la transparence]{style="color:green ; "} et aux meilleures pratiques de recherche pour garantir [l'intégrité]{style="text-decoration : underline ; "}.
::::
