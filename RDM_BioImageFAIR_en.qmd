...
::: {style="text-align: center;font-size: 60%"}
![](images/Microscope.jpeg){fig-alt="A humorous science-themed illustration combining text and a drawing of a microscope. On the left side, bold black text reads 'BRO, DO YOU EVEN SCOPE?' with an illustration of a compound microscope below it. On the right side, within a light blue background, the text emphasizes the importance of training in microscopy: 'A microscope is as good as the person that operates it. Experiment quality can be boosted with training.' The words 'microscope' and 'Experiment quality' are highlighted in blue. The image humorously promotes proper training for obtaining high-quality scientific results using microscopes." fig-align="center" width="100%"}
:::
